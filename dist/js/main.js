...
/* harmony import */ var _observable__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./observable */ "./src/js/observable.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./helpers */ "./src/js/helpers.js");
...
var TowaGdprCookie = /*#__PURE__*/function () {
  function TowaGdprCookie(cookie, root) {
    ...
    this.ref = {
      root: root,
      domEls: root.querySelectorAll("[data-cookiename=\"".concat(this.state.name, "\"]")),
      domEl: root.querySelector("[data-cookiename=\"".concat(this.state.name, "\"]")),
      listEls: Array.from(root.querySelectorAll("[data-cookiename=\"".concat(this.state.name, "\"]"))).map(function (item) {
  ...
  _createClass(TowaGdprCookie, [{
    ...
    value: function render() {
      ...
      this.ref.domEls.forEach(function (domel) {
        domel.checked = _this.state.active.value;
      });
      this.ref.listEls.forEach(function (listelement) {
        Object(_helpers__WEBPACK_IMPORTED_MODULE_11__["setCssClass"])(listelement, 'active', _this.state.active.value);
      });
    }
  }, {
    key: "defineObservables",
    value: function defineObservables() {
      var _this2 = this;

      this.state.active = new _observable__WEBPACK_IMPORTED_MODULE_10__["default"](this.state.active, this.ref.domEl);
      this.ref.domEls.forEach(function (domEl) {
        domEl.addEventListener('render', function () {
          _this2.render();
        });
      });
    }
    ...
    value: function isCookieActive() {
      return !!(js_cookie__WEBPACK_IMPORTED_MODULE_9___default.a.get(this.state.name) === 'true');
    }
  }, {
    key: "accept",
    ...
    key: "save",
    value: function save() {
      js_cookie__WEBPACK_IMPORTED_MODULE_9___default.a.set(this.state.name, !!this.state.active.value, {
    ...
    value: function setActive(value) {
      var notifyRoot = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      ...
      js_cookie__WEBPACK_IMPORTED_MODULE_9___default.a.set(this.state.name, value, {
        expires: parseInt(towaGdprContext.settings.cookieTime),
        sameSite: 'lax'
      });
    }
    ...
    key: "getCookieForLog",
    value: function getCookieForLog() {
      return _defineProperty({}, this.state.name, this.state.active.value);
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EssentialCookie; });
...
/* harmony import */ var _cookie__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cookie */ "./src/js/cookie.js");
...
var EssentialCookie = /*#__PURE__*/function (_TowaGdprCookie) {
  _inherits(EssentialCookie, _TowaGdprCookie);

  var _super = _createSuper(EssentialCookie);

  function EssentialCookie() {
    _classCallCheck(this, EssentialCookie);

    return _super.apply(this, arguments);
  }

  _createClass(EssentialCookie, [{
    key: "isCookieActive",
    value: function isCookieActive() {
      return true;
    }
...
}(_cookie__WEBPACK_IMPORTED_MODULE_5__["default"]);
...
/* harmony import */ var _observable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./observable */ "./src/js/observable.js");
...
var CookieGroup = /*#__PURE__*/function () {
  function CookieGroup(group, root) {
    _classCallCheck(this, CookieGroup);

    var domEl = root.querySelector("[data-groupname=\"".concat(group.title, "\"]"));
    this.state = {
  ...
  _createClass(CookieGroup, [{
    key: "getCookies",
    value: function getCookies(group) {
      var _this = this;

      if (group.cookies instanceof Object) {
        this.state.cookies = group.cookies.map(function (cookie) {
          return new _cookie__WEBPACK_IMPORTED_MODULE_1__["default"](cookie, _this.ref.root);
        });
      }
    }
  }, {
    ...
    key: "defineObservables",
    value: function defineObservables() {
      this.state.active = new _observable__WEBPACK_IMPORTED_MODULE_2__["default"](this.state.active, this.ref.domEl);
    }
  }, {
    key: "isGroupActive",
    value: function isGroupActive() {
      return !!this.state.cookies.find(function (cookie) {
        return !!cookie.state.active.value;
      });
    }
  }, {
    key: "render",
    ...
    value: function toggle() {
      ...
      this.state.cookies.forEach(function (cookie) {
        cookie.setActive(_this2.state.active.value, false);
      });
    }
  }, {
    key: "setListeners",
    value: function setListeners() {
      ...
      this.ref.domEl.addEventListener('render', function () {
        _this3.render();
      });
      ...
      this.ref.root.addEventListener('cookieChanged', function () {
        _this3.state.active.value = _this3.isGroupActive();
      });
      ...
      if (this.ref.accordionBtn) {
        this.ref.accordionBtn.addEventListener('click', function () {
    ...
    key: "getCookiesForLog",
    value: function getCookiesForLog() {
      return this.state.cookies.map(function (cookie) {
...
/***/ "./src/js/cookiegroupEssential.js":
/*!****************************************!*\
  !*** ./src/js/cookiegroupEssential.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EssentialCookieGroup; });
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es7.symbol.async-iterator */ "./node_modules/core-js/modules/es7.symbol.async-iterator.js");
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es6.symbol */ "./node_modules/core-js/modules/es6.symbol.js");
/* harmony import */ var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var core_js_modules_es6_reflect_construct__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! core-js/modules/es6.reflect.construct */ "./node_modules/core-js/modules/es6.reflect.construct.js");
/* harmony import */ var core_js_modules_es6_reflect_construct__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_reflect_construct__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _cookiegroup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cookiegroup */ "./src/js/cookiegroup.js");
/* harmony import */ var _cookieEssential__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./cookieEssential */ "./src/js/cookieEssential.js");
...
var EssentialCookieGroup = /*#__PURE__*/function (_CookieGroup) {
  _inherits(EssentialCookieGroup, _CookieGroup);

  var _super = _createSuper(EssentialCookieGroup);

  function EssentialCookieGroup() {
    _classCallCheck(this, EssentialCookieGroup);

    return _super.apply(this, arguments);
  }

  _createClass(EssentialCookieGroup, [{
    key: "isGroupActive",
    value: function isGroupActive() {
      return true;
    }
    ...
    value: function getCookies(group) {
      ...
      if (group.cookies instanceof Object) {
        this.state.cookies = group.cookies.map(function (cookie) {
          return new _cookieEssential__WEBPACK_IMPORTED_MODULE_6__["default"](cookie, _this.ref.root);
        });
      }
    }
  }, {
  ...
  return EssentialCookieGroup;
}(_cookiegroup__WEBPACK_IMPORTED_MODULE_5__["default"]);
...
/*!***************************!*\
  !*** ./src/js/helpers.js ***!
  \***************************/
/*! exports provided: convertHexColorToRgbString, setCssClass, deleteAllCookies */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertHexColorToRgbString", function() { return convertHexColorToRgbString; });
...
function convertHexColorToRgbString(hex, opacity) {
  hex = hex.replace('#', '');
  var colorChannels = Object.values({
    r: parseInt(hex.substring(0, 2), 16),
    g: parseInt(hex.substring(2, 4), 16),
    b: parseInt(hex.substring(4, 6), 16),
    a: opacity
  }).join(',');
  return "rgba(".concat(colorChannels, ")");
}
function setCssClass(element, className, state) {
  if (!state) {
...
/* harmony import */ var _cookiegroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cookiegroup */ "./src/js/cookiegroup.js");
/* harmony import */ var _observable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./observable */ "./src/js/observable.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers */ "./src/js/helpers.js");
/* harmony import */ var _cookiegroupEssential__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./cookiegroupEssential */ "./src/js/cookiegroupEssential.js");
...
var TowaGdprPlugin = /*#__PURE__*/function () {
  function TowaGdprPlugin() {
    ...
    if (this.context.settings.cookie_groups instanceof Object) {
      this.state.cookieGroups = this.context.settings.cookie_groups.map(function (group, index) {
        return new _cookiegroup__WEBPACK_IMPORTED_MODULE_4__["default"](group, _this.refs.root);
      });
    }

    if (this.context.settings.essential_group instanceof Object) {
      var group = new _cookiegroupEssential__WEBPACK_IMPORTED_MODULE_7__["default"](this.context.settings.essential_group, this.refs.root, false);
  ...
  _createClass(TowaGdprPlugin, [{
    key: "isGdprAccepted",
    value: function isGdprAccepted() {
      return js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.get('GdprAccepted') === this.context.settings.hash;
    }
  }, {
    key: "init",
    value: function init() {
    ...
    value: function defineObservables() {
      ...
      this.state.accepted = new _observable__WEBPACK_IMPORTED_MODULE_5__["default"](this.state.accepted, this.refs.root);
      this.refs.root.addEventListener('render', function () {
        _this2.render();
      });
    }
  }, {
    key: "render",
    value: function render() {
      Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["setCssClass"])(this.refs.root, 'show', !this.state.accepted.value);
    }
  }, {
    key: "applySettings",
    value: function applySettings() {
      if (this.context.settings.highlight_color) {
        var highlightColorLight = Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["convertHexColorToRgbString"])(this.context.settings.highlight_color, 0.1);
    ...
    value: function acceptAll() {
      this.state.cookieGroups.forEach(function (group) {
    ...
    value: function accept() {
      ...
      js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.set('GdprAccepted', this.context.settings.hash, {
    ...
    value: function saveConsent() {
      var cookies = this.state.cookieGroups.flatMap(function (group) {
    ...
    value: function declineAll() {
      Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["deleteAllCookies"])();
      this.state.cookieGroups.forEach(function (group) {
    ...
    value: function setListeners() {
      ...
      this.refs.triggerPopupLinks.forEach(function (link) {
        link.addEventListener('click', function () {
          _this3.state.accepted.value = false;
        });
      });
    }
  }, {
    key: "isNoCookiePage",
    value: function isNoCookiePage() {
...
var towagdpr = new TowaGdprPlugin();
...
var Observable = /*#__PURE__*/function () {
  function Observable(value, targetNode) {
...
/* harmony import */ var new_event_polyfill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! new-event-polyfill */ "./node_modules/new-event-polyfill/newEventPolyfill.js");
/* harmony import */ var new_event_polyfill__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(new_event_polyfill__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var array_flat_polyfill__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! array-flat-polyfill */ "./node_modules/array-flat-polyfill/index.mjs");
...
__webpack_require__(/*! C:\xampp\htdocs\towa-dsgvo-plugin\wp-content\plugins\towa-gdpr-plugin\src\js\main.js */"./src/js/main.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\towa-dsgvo-plugin\wp-content\plugins\towa-gdpr-plugin\src\scss\main.scss */"./src/scss/main.scss");
